use crate::anaylze::syntax::expr::{Caculate, Literal};
...
mod test {
    use super::*;
    use crate::anaylze::syntax::expr::{ExprVar, Factor, Item, LexIter, SubCaculate, SubItem};
    use crate::anaylze::Var;
    use crate::anaylze::{PreviewableIter, Value};
